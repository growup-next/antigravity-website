...
export default function FluidBackground() {
  ...
  useEffect(() => {
    ...
    function createShader(type: number, source: string): any {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    function createProgram(vsSource: string, fsSource: string): any {
    ...
    const programs = [
      splatProgram, curlProgram, vorticityProgram, divergenceProgram,
      clearProgram, pressureProgram, gradientSubtractProgram, advectionProgram, displayProgram,
    ];
