...
const documents: SeedDocument[] = [
  ...
  },
  {
    source: "料金シミュレーター / オプション",
    category: "料金",
    text: "追加オプション続き: AIチャットボット（24時間自動応答）5万円、SNS投稿生成（AIによるSNS投稿コンテンツ自動生成）2.5万円、SEO支援パック（メタタグ最適化・構造化データ設定）3万円、口コミ返信アシスト（Googleマップ口コミへのAI返信下書き）2万円、ロゴ・名刺制作（AIデザイン）3.5万円。正式な見積もりはヒアリング後に提示されます。",
  },
  {
